...
import WebComm.Artisti;
import WebComm.Categorie;
import WebComm.Commenti;
import WebComm.Eventi;
import WebComm.Utenti;
...
public class CRUD {
    ...
    public List<Eventi> query1(int anno) {
    ...
    public List<Eventi> listAttivita() {
        Session session = factory.openSession();
    ...
    public List<Eventi> listTutteAttivita() {
        Session session = factory.openSession();
        ArrayList<Eventi> att = new ArrayList<Eventi>();
        att = null;
        Transaction tx = null;
    ...
    /* Method to
     READ the activity */
    public List<Eventi> listAttivitaById(Integer id) {
        Session session = factory.openSession();
        Transaction tx = null;
        try {
            tx = session.beginTransaction();
    ...
    public boolean saveCliente(Utenti c) {
        Session session = factory.openSession();
        Transaction tx = null;
        try {
